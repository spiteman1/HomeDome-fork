    ...
    <style>
        ...
        * { box-sizing: border-box;
        ...
        .hero-title span { display: inline-block;
            animation: elasticBounce 3s ease-out infinite; }

        @keyframes elasticBounce {
            0% { transform: translateY(0) scale(1); opacity: 0.5; }
            20% { transform: translateY(-20px) scale(1.1); opacity: 1; }
            40% { transform: translateY(8px) scale(0.96); }
        ...
        .hero-title span:nth-child(12) { animation-delay: 0.60s; }
        .hero-title span:nth-child(13) { animation-delay: 0.65s; }
        .hero-title span:nth-child(14) { animation-delay: 0.70s; }
        .hero-title span:nth-child(15) { animation-delay: 0.75s; }
        .hero-title span:nth-child(16) { animation-delay: 0.80s; }
        .hero-title span:nth-child(17) { animation-delay: 0.85s; }
        .hero-title span:nth-child(18) { animation-delay: 0.90s; }
        .hero-title span:nth-child(19) { animation-delay: 0.95s; }
        .hero-title span:nth-child(20) { animation-delay: 1.0s; }
...
<div class="page">
    ...
    <h1 class="hero-title">
        ...
        <span>&nbsp;</span>
        <span>H</span><span>o</span><span>m</span><span>e</span><span>D</span><span>o</span><span>m</span><span>e</span>
    </h1>
                <p class="hero-sub">
