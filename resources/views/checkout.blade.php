...
<div class="CheckoutPage">
    ...
    <div class="FirstRow">
        ...
        <p>Total amount:</p>
        <p id="TotalAmount">£250.00</p>
        </div>
        </div>
        <div class="Checkout">
    <button id="checkOut">Place Order and Pay now</button>
    </div>
            <h3 id="Title">Your Items</h3>
    <div class="BasketSummary">
        <div class="img">
        <img src="table.webp" alt="Item Image">
        </div>
        <p class="ItemName">Luxurious wooden table</p>
        <div class="ItemPrice">
            <p id="ItemPriceLabel">Price:</p>
            <p id="ItemPrice">£250.00</p> 
        </div>
        <div class="quantity">
        <p id="qtyLabel">Quantity:</p>
        <p id="ItemPrice">1</p>
        </div> 
    </div> 
        </div>
