@vite('resources/css/app.css')
    ...
    <header>
       ...
       <a class="logo-container headerLinks" href="/">
           <img class="removeWhitespace" src="/images/homeDomeLogo.png" alt="homeDomeLogo" height="60" width="60">
     ...
     <p > Hello ,<a class="headerLinks" href="Sign In">Sign In or Sign Up</a></p>
        ...
        <section id= "categories" >
            ...
            <a class= "headerLinks" href="/kitchenWare">Kitchenware</a>
