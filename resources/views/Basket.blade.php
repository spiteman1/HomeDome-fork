                        ...
                        <div class="ProductInfo">
                            ...
                            <div class="ProductDetails">
                                ...
                                <div class="controls-row">
                                    ...
                                    <form method="POST"
                                        action="{{ route('updateQuantity.updateQuantity', ['bid' => $product->id]) }}">
                                        @csrf
                                        <select name="quantity" id="quantity" onchange="this.form.submit()">
                                            @for ($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ $product->quantity == $i ? 'selected' : '' }}>{{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                    </form>
                                    ...
                                    <form method="POST"
                                        action="{{ route('removeProduct.removeProduct', ['bid' => $product->id]) }}">
                                        @csrf
